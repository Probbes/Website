 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var z_;function bx(){return z_||(z_=1,function(s){function e(X,ae){var Q=X.length;X.push(ae);e:for(;0<Q;){var ye=Q-1>>>1,P=X[ye];if(0<l(P,ae))X[ye]=ae,X[Q]=P,Q=ye;else break e}}function i(X){return X.length===0?null:X[0]}function r(X){if(X.length===0)return null;var ae=X[0],Q=X.pop();if(Q!==ae){X[0]=Q;e:for(var ye=0,P=X.length,ie=P>>>1;ye<ie;){var Te=2*(ye+1)-1,Re=X[Te],Y=Te+1,he=X[Y];if(0>l(Re,Q))Y<P&&0>l(he,Re)?(X[ye]=he,X[Y]=Q,ye=Y):(X[ye]=Re,X[Te]=Q,ye=Te);else if(Y<P&&0>l(he,Q))X[ye]=he,X[Y]=Q,ye=Y;else break e}}return ae}function l(X,ae){var Q=X.sortIndex-ae.sortIndex;return Q!==0?Q:X.id-ae.id}if(s.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var u=performance;s.unstable_now=function(){return u.now()}}else{var d=Date,f=d.now();s.unstable_now=function(){return d.now()-f}}var p=[],h=[],g=1,v=null,y=3,S=!1,M=!1,b=!1,x=typeof setTimeout=="function"?setTimeout:null,_=typeof clearTimeout=="function"?clearTimeout:null,L=typeof setImmediate<"u"?setImmediate:null;function w(X){for(var ae=i(h);ae!==null;){if(ae.callback===null)r(h);else if(ae.startTime<=X)r(h),ae.sortIndex=ae.expirationTime,e(p,ae);else break;ae=i(h)}}function C(X){if(b=!1,w(X),!M)if(i(p)!==null)M=!0,$();else{var ae=i(h);ae!==null&&ce(C,ae.startTime-X)}}var z=!1,F=-1,N=5,G=-1;function A(){return!(s.unstable_now()-G<N)}function T(){if(z){var X=s.unstable_now();G=X;var ae=!0;try{e:{M=!1,b&&(b=!1,_(F),F=-1),S=!0;var Q=y;try{t:{for(w(X),v=i(p);v!==null&&!(v.expirationTime>X&&A());){var ye=v.callback;if(typeof ye=="function"){v.callback=null,y=v.priorityLevel;var P=ye(v.expirationTime<=X);if(X=s.unstable_now(),typeof P=="function"){v.callback=P,w(X),ae=!0;break t}v===i(p)&&r(p),w(X)}else r(p);v=i(p)}if(v!==null)ae=!0;else{var ie=i(h);ie!==null&&ce(C,ie.startTime-X),ae=!1}}break e}finally{v=null,y=Q,S=!1}ae=void 0}}finally{ae?O():z=!1}}}var O;if(typeof L=="function")O=function(){L(T)};else if(typeof MessageChannel<"u"){var H=new MessageChannel,q=H.port2;H.port1.onmessage=T,O=function(){q.postMessage(null)}}else O=function(){x(T,0)};function $(){z||(z=!0,O())}function ce(X,ae){F=x(function(){X(s.unstable_now())},ae)}s.unstable_IdlePriority=5,s.unstable_ImmediatePriority=1,s.unstable_LowPriority=4,s.unstable_NormalPriority=3,s.unstable_Profiling=null,s.unstable_UserBlockingPriority=2,s.unstable_cancelCallback=function(X){X.callback=null},s.unstable_continueExecution=function(){M||S||(M=!0,$())},s.unstable_forceFrameRate=function(X){0>X||125<X?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):N=0<X?Math.floor(1e3/X):5},s.unstable_getCurrentPriorityLevel=function(){return y},s.unstable_getFirstCallbackNode=function(){return i(p)},s.unstable_next=function(X){switch(y){case 1:case 2:case 3:var ae=3;break;default:ae=y}var Q=y;y=ae;try{return X()}finally{y=Q}},s.unstable_pauseExecution=function(){},s.unstable_requestPaint=function(){},s.unstable_runWithPriority=function(X,ae){switch(X){case 1:case 2:case 3:case 4:case 5:break;default:X=3}var Q=y;y=X;try{return ae()}finally{y=Q}},s.unstable_scheduleCallback=function(X,ae,Q){var ye=s.unstable_now();switch(typeof Q=="object"&&Q!==null?(Q=Q.delay,Q=typeof Q=="number"&&0<Q?ye+Q:ye):Q=ye,X){case 1:var P=-1;break;case 2:P=250;break;case 5:P=1073741823;break;case 4:P=1e4;break;default:P=5e3}return P=Q+P,X={id:g++,callback:ae,priorityLevel:X,startTime:Q,expirationTime:P,sortIndex:-1},Q>ye?(X.sortIndex=Q,e(h,X),i(p)===null&&X===i(h)&&(b?(_(F),F=-1):b=!0,ce(C,Q-ye))):(X.sortIndex=P,e(p,X),M||S||(M=!0,$())),X},s.unstable_shouldYield=A,s.unstable_wrapCallback=function(X){var ae=y;return function(){var Q=y;y=ae;try{return X.apply(this,arguments)}finally{y=Q}}}}(yd)),yd}var I_;function Tx(){return I_||(I_=1,vd.exports=bx()),vd.exports}var Sd={exports:{}},Tn={};/**
 * @license React
...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Va,depthTest:!1,depthWrite:!1})}function Kv(){return new Wa({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:gp(),fragmentShader:`
		...
		`,blending:Va,depthTest:!1,depthWrite:!1})}function Qv(){return new Wa({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:gp(),fragmentShader:`
...
`:"";i.isRawShaderMaterial?(x=["#define SHADER_TYPE "+i.shaderType,"#define SHADER_NAME "+i.shaderName,M].filter(Xo).join(`
`),x.length>0&&(x+=`
